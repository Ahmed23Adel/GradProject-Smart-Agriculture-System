...
const reports = ref();
const getReportRequester = new HttpRequester("get_all_reports");
getReportRequester.callApi("GET").then((res) => {
  console.log("res", res);
  ...
  <div class="report-container">
    ...
    <div class="summary-container">
      <div class="main-container">
        <div
          class="card"
          :class="{ selected: selectedReport == i }"
    ...
    <div class="page-container">
      <div v-if="reports" class="report-components-wraper">
        ...
        <div
          ...
          v-if="reports[selectedReport].questions_answers"
        >
          <div
          ...
          >
            ...
            <p>
              {{
                reports[selectedReport]?.questions_answers[i]?.question_answer
              }}
            </p>
          </div>
        </div>
