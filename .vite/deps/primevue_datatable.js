import {
  script as script12
} from "./chunk-ACQMH5PW.js";
import {
  FocusTrap
} from "./chunk-C47WJPFF.js";
import {
  script as script8
} from "./chunk-OZLP6XFT.js";
import {
  script as script10
} from "./chunk-MDI2MW7E.js";
import {
  script as script9
} from "./chunk-WZI7JKMY.js";
import {
  script as script11
} from "./chunk-ED5Z6RCG.js";
import {
  script as script7
} from "./chunk-EL2HPZP4.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-AT24X4ZL.js";
import "./chunk-3MC36DH4.js";
import {
  script as script4
} from "./chunk-6E44OBEQ.js";
import {
  script as script5
} from "./chunk-VIG2E4FD.js";
import {
  script as script6
} from "./chunk-2RBOA4UY.js";
import {
  Ripple
} from "./chunk-CJVBAWKN.js";
import {
  OverlayEventBus
} from "./chunk-NF5D75TH.js";
import {
  script as script3
} from "./chunk-NKZ5T5PT.js";
import {
  script as script2
} from "./chunk-PF6JLEIZ.js";
import {
  BaseStyle,
  script
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16)) : createCommentVNode("", true)], 16, _hoisted_16)) : (openBlock(), createElementBlock(Fragment, {
    key: 1
...
var _hoisted_17 = ["id"];
var _hoisted_26 = ["id", "value", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-invalid"];
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
  ...
  }, _objectSpread2(_objectSpread2({}, _ctx.inputProps), _ctx.ptm("input"))), null, 16, _hoisted_26)) : (openBlock(), createElementBlock("span", mergeProps({
    key: 1,
    ref: "focusInput",
    id: _ctx.inputId,
    "class": [_ctx.cx("input"), _ctx.inputClass],
    ...
    _: 3
  }, 8, ["appendTo"])], 16, _hoisted_17);
}
script19.render = render7;
...
var _hoisted_110 = ["aria-label", "aria-current", "onClick", "data-p-highlight"];
...
var _hoisted_52 = [_hoisted_118, _hoisted_216, _hoisted_32, _hoisted_42];
...
var _hoisted_121 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-highlight", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
...
var script33 = {
  ...
  methods: {
      ...
      for (var i = 0; i < data14.length; i++) {
            ...
            if (filterMeta.operator) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  localMatch = this.executeLocalFilter(filterField, data14[i], filterConstraint);
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](ObjectUtils.resolveFieldData(data14[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
    ...
    onSpaceKey: function onSpaceKey2(event2, rowData, rowIndex2, slotProps) {
      ...
      if (event2.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[0], data14);
          lastSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[this.selection.length - 1], data14);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = ObjectUtils.findIndexInList(this.selection, data14);
        }
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(ObjectUtils.resolveFieldData(data14, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(ObjectUtils.resolveFieldData(data14, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    exportCSV: function exportCSV(options2, data14) {
      var _this6 = this;
      var csv = "\uFEFF";
      if (!data14) {
        data14 = this.processedData;
        if (options2 && options2.selectionOnly)
          data14 = this.selection || [];
        else if (this.frozenValue)
          data14 = data14 ? [].concat(_toConsumableArray3(this.frozenValue), _toConsumableArray3(data14)) : this.frozenValue;
      }
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event2 = e.originalEvent;
      var data14 = e.data;
      var groupFieldValue = ObjectUtils.resolveFieldData(data14, this.groupRowsBy);
  ...
  computed: {
    columns: function columns() {
      ...
      if (this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray3(cols.filter(function(item2) {
    ...
    processedData: function processedData() {
      ...
      if (!this.lazy && !((_this$virtualScroller = this.virtualScrollerOptions) !== null && _this$virtualScroller !== void 0 && _this$virtualScroller.lazy)) {
        if (data14 && data14.length) {
          ...
          if (this.sorted) {
            if (this.sortMode === "single")
              data14 = this.sortSingle(data14);
            else if (this.sortMode === "multiple")
              data14 = this.sortMultiple(data14);
          }
        }
      }
      return data14;
  ...
  components: {
    ...
    ArrowDownIcon: script13,
    ArrowUpIcon: script14,
    SpinnerIcon: script6
  }
};
function _typeof5(o) {
